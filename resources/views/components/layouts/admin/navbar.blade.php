...
<aside class="hidden lg:hidden fixed left-0 top-0 bottom-0 right-0 bg-black/40 z-50" id="navbar-menu-mobile">
...
<header class="fixed lg:hidden top-0 left-0 right-0 max-w-[720px] mx-auto flex items-center justify-between px-6 py-7 z-40 bg-white">
