...
<section>
    <div class="grid grid-cols-1 gap-y-6">
        ...
        <div class="flex flex-col gap-y-4">
            ...
            <p class="text-sm text-gray-700 border-[0.5px] border-[#D9D9D9] bg-transparent rounded-[10px] py-2 px-3.5">{{ $siswa->username }}</p>
        </div>
        <div class="flex flex-col gap-y-4">
            <p class="text-sm font-bold ">Nama</p>
            <p class="text-sm text-gray-700 border-[0.5px] border-[#D9D9D9] bg-transparent rounded-[10px] py-2 px-3.5">{{ $siswa->nama }}</p>
        </div>
        <div class="flex flex-col gap-y-4">
            <p class="text-sm font-bold ">Kelas</p>
            <p class="text-sm text-gray-700 border-[0.5px] border-[#D9D9D9] bg-transparent rounded-[10px] py-2 px-3.5">{{ $siswa->kelas->nama }}</p>
        </div>
