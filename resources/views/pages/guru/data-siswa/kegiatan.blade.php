    ...
    <section>
        <div class="mb-[40px]">
            <div class="flex gap-x-4 items-center">
                <a href="{{ route('guru.data.kelas.siswa') }}"><i data-feather="chevron-left" class="bg-primary rounded-[5px] text-white"></i></a>
                <p class="text-sm text-gray-500 font-bold">XII RPL 1</p>
                <i data-feather="chevron-right" class="text-gray-500"></i>
                <p class="text-sm font-bold">Abiya Azka Rihan</p>
            </div>
        </div>
        <div class="grid gap-y-4    ">
            ...
            <form action="#" method="GET" class="flex items-center gap-2.5">
                @csrf
                <div class="relative">
                ...
                @if(request('search'))
                    <a href="#" class="bg-gray-500 text-white rounded-full px-5 py-2.5 text-xs font-semibold">
                        Reset
                    </a>
                @endif
            </form>
            ...
            <table class="min-w-full w-max">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="bg-[#F5F5F5] px-4 py-2 text-black text-sm font-medium border-l border-l-[#D9D9D9]">01-03-2025</td>
                        <td class="bg-[#F5F5F5] px-4 py-2 text-black text-sm font-medium border-l border-l-[#D9D9D9]">Sholat Fardhu</td>
                        <td class="bg-[#F5F5F5] px-4 py-2 text-black text-sm font-medium border-l border-l-[#D9D9D9] text-center">Sholat Fardhu</td>
                        <td class="bg-[#F5F5F5] px-6 py-2.5 text-black text-sm font-medium border-l border-l-[#D9D9D9] ">
                            <button type="button" onclick="showPhotoPopup('#')" class="foto-kegiatan flex justify-center gap-x-2 items-center px-2.5 py-[5px] text-sm font-semibold text-blue-500 ">
