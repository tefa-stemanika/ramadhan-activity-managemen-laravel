...
@section('main')
    ...
    <div class="flex space-x-8">
        ...
        <p class="text-base font-bold">Tambah Guru PABP Baru</p>
    </div>

    <section class="mt-11">
        <form action="{{ route('guru.store') }}" method="POST" class="bg-white p-15 space-y-6 rounded-md border-[1.5px] border-[#D9D9D9] max-w-[750px]">
            @csrf
            @method('POST')
