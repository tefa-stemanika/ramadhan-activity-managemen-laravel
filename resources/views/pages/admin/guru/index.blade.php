    ...
    <section>
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2.5">
                <a href="guru/create" class="flex items-center gap-4 px-5 py-2 rounded bg-transparent border border-primary text-primary">
            ...
            <table class="min-w-full w-max">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="bg-[#F5F5F5] px-6 py-2.5 text-black text-sm font-medium border-l border-l-[#D9D9D9]">wvj01</td>
                        <td class="bg-[#F5F5F5] px-6 py-2.5 text-black text-sm font-medium border-l border-l-[#D9D9D9]">Elin Yohana, S.Pd</td>
