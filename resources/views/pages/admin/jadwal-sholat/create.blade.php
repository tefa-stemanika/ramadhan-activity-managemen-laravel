    ...
    <section>
        ...
        <form action="{{ route('jadwal-sholat.store') }}" method="POST" class="bg-white p-4  md:p-15 space-y-3 md:space-y-6 rounded-md border-[1.5px] border-[#D9D9D9] max-w-[750px]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="date" name="tanggal" id="tanggal" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="imsak" id="imsak" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="subuh" id="subuh" class="col-span-3 bg-white px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="terbit" id="terbit" class="col-span-3 bg-white px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="dhuha" id="dhuha" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="dzuhur" id="dzuhur" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="ashar" id="ashar" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="maghrib" id="maghrib" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3 items-center">
                ...
                <input type="time" name="isya" id="isya" class="col-span-3 bg-white  px-3 py-2 md:px-5 md:py-3.5 rounded-md border-[0.5px] border-[#D9D9D9]">
