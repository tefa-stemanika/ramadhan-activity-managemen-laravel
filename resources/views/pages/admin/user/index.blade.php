        ...
        <div class="flex items-center justify-between">
            ...
            <form class="flex items-center gap-2.5 w-full md:w-auto">
                <div class="relative w-full md:w-auto">
                    ...
                    <input type="search" name="search" value="{{ request('search') }}" placeholder="Cari User..." class="w-full md:w-auto bg-white rounded-full pl-9 pr-2.5 py-1 border border-primary">
                </div>
